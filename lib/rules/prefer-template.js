        ...
        function getNodesWithExtraneousWhitespaceRemoved(textNodes) {
            return textNodes.map(textNode => {
                if (isExtraneousWhitespaceToBeRemoved(textNode)) {
                    console.info('isExtraneousWhitespaceToBeRemoved:textNode'); // eslint-disable-line
                    console.dir(textNode, { showHidden: true, depth: null, colors: true }); // eslint-disable-line
        ...
        */
        function getTemplateLiteral(currentNode, textBeforeNode, textAfterNode) {
            ...
            if (currentNode.type === "Literal" && typeof currentNode.value === "string") {
                console.info("currentNode.value", currentNode.value); // eslint-disable-line
                console.info("currentNode.raw", currentNode.raw); // eslint-disable-line
            ...
            if (currentNode.type === "TemplateLiteral") {
                console.info("currentNode.type === 'TemplateLiteral':sourceCodeText", sourceCodeText, "\n\n"); // eslint-disable-line
                console.dir(currentNode, { colors: true, showHidden: true, depth: null }); // eslint-disable-line
            ...
            console.info('text nodes', typeof textBeforeNode, textBeforeNode, typeof textAfterNode, textAfterNode); // eslint-disable-line
            console.dir(currentNode, { showHidden: true, depth: null, colors: true }); // eslint-disable-line
         ...
         * @returns {void}
         */
        function checkForExtraneousWhitespace(node) {
        ...
        return {
            ...
            Identifier: checkForExtraneousWhitespace,
