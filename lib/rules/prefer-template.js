            ...
            Program(node) {
                ...
                tokens.forEach((token, i) => {
                    ...
                    if (token.type === "Template") {
                        console.dir(prevToken); // eslint-disable-line
                        console.dir(token); // eslint-disable-line
                        console.dir(nextToken); // eslint-disable-line
                        console.info('ENDTEMP', !!(token.value.match(/^\}.*`$/) || token.value.match(/\}\w+\$\{/)), token.type === "Template", config.trim, sourceCode.isSpaceBetweenTokens(prevToken, token)); // eslint-disable-line
                    }
